...
void CGraph::CairoGraph::set_background_style(const Gdk::RGBA colour1, const Gdk::RGBA colour2)
{
...
void CGraph::CairoGraph::set_background_style(const Gdk::RGBA colour1)
{
    bg_colour1 = colour1;
    bg_colour2 = colour1;
    queue_draw_area(0, 0,  get_allocation().get_width(), get_allocation().get_height());
